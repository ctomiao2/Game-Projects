...
function GameOverScene:onCreate()
    ...
    display.newSprite("cut_scene.png")
        ...
        :addTo(self)
    display.newSprite("game_over.png")
        :setPosition(display.cx,display.cy)
        :addTo(self)
...
function GameOverScene:inputYourName()
    local res = ""
...
--回到游戏主界面
function GameOverScene:restart()
    GlobalData.yourName = ""
...
--对用户输入的名字进行处理，去掉前后空格，最大长度为10
function GameOverScene:checkName(name)
